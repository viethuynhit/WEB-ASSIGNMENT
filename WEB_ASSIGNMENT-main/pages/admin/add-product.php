            ...
            <div class="col-md-9 col-12">
                <div class="d-flex align-items-start border-0 mb-3">
                    ...
                    <form class="sign-up-form col-11 d-flex flex-column flex-grow-1 align-items-start gap-3 mb-4 ps-4"
                        id="customer-infor" action="">


                        <!-- Product name -->
                        <div class="w-100">
                            <label class="d-block" for="add-product-name">Product name</label>
                            <input class="form-control p-1" type="text" name="product-name" id="add-product-name"
                        ...
                        <div class="w-100">
                            ...
                            <input class="form-control p-1" type="text" name="product-price" id="add-product-price"
                        ...
                        <div class="w-100">
                            ...
                            <input class="form-control p-1" type="number" name="product-stock" id="add-product-stock"
                        ...
                        <div class="w-100">
                            ...
                            <textarea class="form-control p-1" name="product-short-description"
                                id="add-product-short-description" placeholder="Type something here..."
                                required></textarea>
                            <hr class="m-0">
                        </div>
                        ...
                        <div class="w-100">
                            ...
                            <textarea class="form-control p-1" name="product-detailed-description"
                                id="add-product-detailed-description" placeholder="Type something here..."
                                required></textarea>
                            <hr class="m-0">
                        </div>
                        ...
                        <div class="w-100">
                            ...
                            <textarea class="form-control p-1" name="product-specifications"
                                id="add-product-specifications" placeholder="Type something here..."
                                required></textarea>
                            <hr class="m-0">
                        </div>
                        ...
                        <div class="w-100">
                            ...
                            <input class="form-control p-1" type="text" name="product-image" id="add-product-image"
