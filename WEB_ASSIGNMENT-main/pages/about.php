...
<body class="bg-light body-theme-fw">
    ...
    <div class="bg-black row p-5 m-0">
        ...
        <!-- align-self-lg-start -->
        <div class="bg-black col-lg-5 order-lg-0 order-sm-1 order-1 d-flex align-items-center"
            id="about-us-paragraph-1">
            <div>
                <h1 style="font-weight: bolder;">About us</h1>
                <p>Established in 2006, our goal is to deliver a specialist range of microcontrollers and boards for
                    enthusiasts.
                    Since then, we have expanded into computers and personal devices that are open to repair and
                    upgrade,
        ...
        <div class="bg-black col-lg-7 align-self-end justify-content-md-end order-lg-4 order-sm-3 order-3"
