...
<body class="bg-light">
    ...
    <div class="container bg-light p-5">
        ...
        <div class="row align-content-center pt-5 ">
            ...
            <div class="col-md-9 col-12">
                <button class="btn btn-secondary align-self-start ms-3" onclick="" id="change-password-button"
                    type="button">Change password</button>
                <br>
                <br>
                <div class="d-flex align-items-start border-0 mb-3">
                    <form class="sign-up-form col-11 d-flex flex-column flex-grow-1 align-items-start gap-3 mb-4 ps-4"
                        id="customer-infor-change_pass" action="">
                        <!-- Old password-->
                        <div class="w-100">
                            <label class="d-block" for="old-password">Old password</label>
                            <input class="form-control p-1" type="password" name="password" id="old-password"
                        ...
                        <div class="w-100">
                            ...
                            <input class="form-control p-1" type="password" name="password" id="new-password"
    ...
    <script src="../scripts/account_type.js"></script>
