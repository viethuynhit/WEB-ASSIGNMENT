    ...
    <div class="bg-light row p-md-5 m-0" id="detail-body">
        <div class="container ps-md-5 pe-md-5 bg-light">
            ...
            <div class="row" id="admin-button-row">
                <a class="fb fw-bold" href="./product.php"><img src="../images/product-details_back_icon.png"
                        alt="back_icon"> Back to products</a>
            </div>
            <br>
            ...
            <div id="mySlider" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="row align-content-center">
                    ...
                    <div class="col">
                        <button id='product-btn' class="btn btn-primary" type="button" onclick=""
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        <div class="row justify-content-center m-0">
                            <img id='product-slide1-img1' src="" alt="laptop-1-image"
                                class="col-lg-5 col-8 img-fluid p-0 rounded-2">
                    ...
                    <div class="carousel-item">
                        <!-- Image -->
                        <div class="row justify-content-center m-0">
                            <img id='product-slide2-img1' src="" alt="laptop-1-image"
                                class="col-lg-5 col-8 img-fluid p-0 rounded-2">
                    ...
                    <div class="carousel-item">
                        <!-- Image -->
                        <div class="row justify-content-center m-0">
                            <img id='product-slide3-img1' src="" alt="laptop-1-image"
                                class="col-lg-5 col-8 img-fluid p-0 rounded-2">
                    ...
                    <div class="carousel-item">
                        <!-- Image -->
                        <div class="row justify-content-center m-0">
                            <img id='product-slide4-img1' src="" alt="laptop-1-image"
                                class="col-lg-5 col-8 img-fluid p-0 rounded-2">
            ...
            <!-- Menu bar -->
            <div
                class="row border-0 border-top border-bottom border-black justify-content-center fw-bolder pt-2 pb-2  align-content-center">
            ...
            <!-- Main content -->
            <div data-bs-spy="scroll" data-bs-root-margin="0px 0px -40%" data-bs-smoot="true"
                class="scrollspy-example bg-body-tertiary p-md-3 rounded-2 bg-light  align-content-center" tabindex="0">
                <!-- Overview -->
                <div class="container row border-0 border-bottom border-dark ">

                    <div class="col-md-2 col-12">
                        <h4 id="scrollspyHeading1" class="fw-bolder">Overview</h4>
                    </div>
                ...
                <div class="container row pt-3 border-0 border-bottom border-dark">
                    <div class="col-md-2 col-12">
                        <h4 id="scrollspyHeading2" class="fw-bolder">Specs</h4>
                    </div>
                ...
                <div class="container row pt-3 border-0 border-bottom border-dark">
                    <div class="col-md-2 col-12">
                        <h4 id="scrollspyHeading3" class="fw-bolder">What's in the box</h4>
                    </div>
                ...
                <div class="container row pt-3 ">
                    <div class="col-md-2 col-12">
                        <h4 id="scrollspyHeading4" class="fw-bolder">Support</h4>
                    </div>
