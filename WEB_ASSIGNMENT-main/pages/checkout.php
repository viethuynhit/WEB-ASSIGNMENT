        ...
        <div class="row row-cols-lg-2">
            ...
            <div class="customer-information-payment">
                ...
                <div class="d-flex align-items-start border-bottom border-dark mb-3">
                    ...
                    <form class="sign-up-form col-11 d-flex flex-column flex-grow-1 align-items-start gap-3 mb-4 ps-4"
                        id="customer-infor">

                        <!-- Header remain -->
                        <h2 class="fw-bolder fb">Customer information</h2>
                        <!-- Logged or not -->
                        <div class="mb-2">Already have an account? <a class="fb" href="./sign.php">Sign in instead</a>
                        </div>

                        <!-- Email -->
                        <div class="w-100">
                            <label class="d-block" for="customer-infor-email">Email</label>
                            <input class="form-control p-1" type="email" name="email" id="customer-infor-email"
                        ...
                        <div class="w-100">
                            ...
                            <input class="form-control p-1" type="text" name="name" id="customer-infor-name"
                        ...
                        <div class="w-100">
                            ...
                            <input class="form-control p-1" type="text" name="state-province"
                                id="customer-infor-state-province" placeholder="Your state / province" required>
                            <hr class="m-0">
                        </div>
                        ...
                        <div class="w-100">
                            ...
                            <input class="form-control p-1" type="text" name="city" id="customer-infor-city"
                        ...
                        <div class="w-100">
                            ...
                            <input class="form-control p-1" type="text" name="zip" id="customer-infor-zip"
                        ...
                        <div class="w-100">
                            ...
                            <input class="form-control p-1" type="text" name="address" id="customer-infor-address"
                        ...
                        <div class="w-100">
                            ...
                            <input class="form-control p-1" type="text" name="phone" id="customer-infor-phone"
                        ...
                        <ul class="list-group list-group-flush" id="payment-method">
                            ...
                            <li class="form-check bg-light">
                                ...
                                <input class="form-check-input rounded-0 shadow-none" type="radio"
                                    name="flexCheckIndeterminate" id="payment-method-credit-card" checked>
                                <div>
                                    <label class="form-check-label mb-2" for="payment-method-credit-card">Credit card /
                                        Debit card</label>
                                    <img class="d-block mb-4" src="../images/checkout_credit-cards.png"
                                        alt="credit-cards-thumb">
                                    <!-- Form -->
                                    <form class="sign-up-form d-flex flex-column align-items-start gap-3 mb-4"
                                        id="payment-form" action="">

                                        <!-- Name on card -->
                                        <div class="w-100">
                                            <label class="d-block" for="payment-form-name">Name on card</label>
                                            <input class="form-control p-1" type="text" id="payment-form-name"
                                                placeholder="Your Name on the Credit/Debit card" required>
                                            <hr class="m-0">
                                        </div>
                                        ...
                                        <div class="w-100">
                                            ...
                                            <input class="form-control p-1" type="number" id="payment-form-number"
                                        ...
                                        <div class="w-100">
                                            ...
                                            <input class="form-control p-1" type="text" id="payment-form-exp"
                                        ...
                                        <div class="w-100">
                                            ...
                                            <input class="form-control p-1" type="number" id="payment-form-cvv"
                                                placeholder="CVV (3 numbers)" required>
                                            <hr class="m-0">
                                        </div>
                            ...
                            <li class="form-check bg-light">
                                <input class="form-check-input rounded-0 shadow-none" type="radio"
                                    name="flexCheckIndeterminate" id="payment-method-paypal">
                                <div>
                                    <label class="form-check-label mb-2" for="payment-method-paypal">PayPal</label>
                                    <img class="d-block mb-3" src="../images/checkout_PayPal-logo.png"
                                        alt="PayPal-logo">
                                </div>
                            ...
                            <li class="form-check bg-light">
                                <input class="form-check-input rounded-0 shadow-none" type="radio"
                                    name="flexCheckIndeterminate" id="payment-method-googlepay">
                                <div>
                                    <label class="form-check-label mb-2" for="payment-method-googlepay">Google
                                        Pay</label>
                                    <img class="d-block mb-3" src="../images/checkout_GooglePay-logo.png"
                                        alt="GooglePay-logo">
                                </div>
                            </li>
                        </ul>
            ...
            <!-- Order summary -->
            <div
                class="big-order-container d-flex justify-content-md-end justify-content-center justify-content-lg-center">
