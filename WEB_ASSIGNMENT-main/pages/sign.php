    ...
    <div class="form-container d-flex flex-column align-items-center">
        <div class="gap-5">
            ...
            <form class="sign-in-form d-flex flex-column align-items-start gap-3 mb-4 p-4 shadow rounded-3" action="">
                ...
                <input class="sign-input-layout" type="email" id="sign-in-email" name="sign-in-email"
                    placeholder="Email">

                <label class="sign-title-font d-block" for="sign-in-password">Password</label>
                <input class="sign-input-layout" type="password" id="sign-in-password" name="sign-in-password"
            ...
            <form class="sign-up-form d-flex flex-column align-items-start gap-3 mb-4 p-4 shadow rounded-3" action="">
                ...
                <input class="sign-input-layout" type="text" id="sign-up-name" name="sign-up-name"
                    placeholder="More than 1 character">

                <label class="sign-title-font d-block" for="sign-up-phone">Phone number</label>
                <input class="sign-input-layout" type="text" id="sign-up-phone" name="sign-up-phone"
                    placeholder="Exact 10 characters">

                <label class="sign-title-font d-block" for="sign-up-address">Address</label>
                <input class="sign-input-layout" type="text" id="sign-up-address" name="sign-up-address"
                    placeholder="Address">

                <label class="sign-title-font d-block" for="sign-up-email">Email</label>
                <input class="sign-input-layout" type="email" id="sign-up-email" name="sign-up-email"
                    placeholder="Email">

                <label class="sign-title-font d-block" for="sign-up-password">Password</label>
                <input class="sign-input-layout" type="password" id="sign-up-password" name="sign-up-password"
                ...
                <input class="sign-input-layout" type="password" id="sign-up-password-confirm"
                    name="sign-up-password-confirm" placeholder="Confirm your password">

                <!-- Terms and Policy -->
                <div class="sign-footer-font">
                    By creating an account you are agreeing to
                    <a class="sign-footer-font" href="https://www.iubenda.com/terms-and-conditions/28927739">Terms of
                        Service</a> and
                    <a class="sign-footer-font" href="https://www.iubenda.com/privacy-policy/28927739">Privacy
                        Policy</a>
                </div>
                <!-- button submit -->
                <div>
            ...
            <form class="sign-forgot-form d-flex flex-column align-items-start gap-3 mb-4 p-4 shadow rounded-3"
                action="">
                ...
                <input class="sign-input-layout" type="email" id="sign-forgot-email" name="sign-forgot-email"
                    placeholder="Email">

                <!-- button submit -->
                <div>
                    <button class="btn btn-primary sign-btn-font" type="button"
                        id="forgot-password-button">Submit</button>
                </div>
            </form>
        </div>
    </div>
